...
def _is_like(embed): return bool(embed.description) and embed.description.startswith(('Вы успешно лайкнули', 'You successfully liked', 'Du hast den Server erfolgreich geliked'))
